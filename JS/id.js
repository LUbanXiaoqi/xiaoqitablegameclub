$(() => {
    ...
    $("#gargoyle").click(() => {
        $("#all>table img").attr("src","../image/id/gargoyle.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#BV").click(() => {
        $("#all>table img").attr("src", "../image/id/BV.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#postman").click(() => {
        $("#all>table img").attr("src", "../image/id/postman.jpg");
        $("#poor1").html("属于好人平民，胜利条件和平民相同");
    ...
    $("#vote").click(() => {
        $("#all>table img").attr("src", "../image/id/vote.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#taobao").click(() => {
        $("#all>table img").attr("src", "../image/id/taobao.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
