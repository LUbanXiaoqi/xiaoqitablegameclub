$(() => {
    ...
    $("#mirrorwlof").click(()=>{
        $("#hide>table #id").attr("src", "../../image/id/mirrorwolf.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#BV").click(() => {
        $("#hide>table #id").attr("src", "../../image/id/BV.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#postman").click(() => {
        $("#hide>table #id").attr("src", "../../image/id/postman.jpg");
        $("#poor1").html("属于好人平民，胜利条件和平民相同");
    ...
    $("#VKG").click(() => {
        $("#hide>table #id").attr("src", "../../image/id/VKG.jpg");
    ...
    $("#senior").click(() => {
        $("#hide>table #id").attr("src", "../../image/id/senior.jpg");
        $("#poor1").html("属于好人平民，胜利条件和平民相同");
    ...
    $("#reincarnator").click(() => {
        $("#hide>table #id").attr("src", "../../image/id/reincarnator.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
        $("#poor2").html("从第二晚开始，你可以发动仅有一次的【轮回】技能");
        $("#poor3").html("1、被轮回的玩家的技能可以保留<br>2、轮回的效果详见【版型说明】")
    });
    $("#vote").click(() => {
        $("#hide>table #id").attr("src", "../../image/id/vote.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#taobao").click(() => {
        $("#hide>table #id").attr("src", "../../image/id/taobao.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
