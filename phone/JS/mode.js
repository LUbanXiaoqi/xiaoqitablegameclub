$(() => {
    // 显示表格
    $(".block").click(() => $("#hide").css("display", "block"));
    // 关闭按钮
    ...
    $("#robot").click(() => {
        $("#hide>img").attr("src", "../../../image/id/robot.jpg");
    ...
    $("#timewolfking").click(() => {
        $("#hide>img").attr("src", "../../../image/id/timewolfking.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#beauty").click(() => {
        $("#hide>img").attr("src", "../../../image/id/beauty.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#burglar").click(() => {
        $("#hide>img").attr("src", "../../../image/id/burglar.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#nightmare").click(() => {
        $("#hide>img").attr("src", "../../../image/id/nightmare.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#lilith").click(()=>{
        $("#hide>img").attr("src","../../../image/id/lilith.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#maid").click(() => {
        $("#hide>img").attr("src", "../../../image/id/maid.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#claw").click(() => {
        $("#hide>img").attr("src", "../../../image/id/claw.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#nighteacher").click(() => {
        $("#hide>img").attr("src", "../../../image/id/nighteacher.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#fristlove").click(()=>{
        $("#hide>img").attr("src", "../../../image/id/FL.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#brother_wolf").click(()=>{
        $("#hide>img").attr("src", "../../../image/id/brother_wolf.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#wolf_brother").click(()=>{
        $("#hide>img").attr("src", "../../../image/id/wolf_brother.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
        $("#poor2").html("狼人阵营，先和兄见面，然后不加入狼队，狼兄出局后会在次日夜晚获得狂暴刀，在使用狂暴刀的次日夜晚和其他队友见面");
        $("#poor3").html("1、在狼兄出局之前，你被预言家查验会显示为【好人】<br>2、在狼兄出局之后，你被预言家查验会显示为【狼人】<br>3、由于你会在狼兄出局后带有狂暴刀请务必保证狼兄出局在你之前<br>4、你的狂暴刀不会被女巫解救，但会被守卫保护<br>5、你的狂暴刀不会保留至下一夜晚");
    });
    $("#KID_wolfking").click(()=>{
        $("#hide>img").attr("src", "../../../image/id/KID_wolfking.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#mirrorwlof").click(()=>{
        $("#hide>img").attr("src", "../../../image/id/mirrorwolf.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
    ...
    $("#PM").click(()=>{
        $("#hide>img").attr("src", "../../../image/id/PM.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
        $("#poor2").html("知道狼队全体成员的位置，最后一狼可以接刀，每晚可以令一名玩家的查验结果相反");
        $("#poor3").html("1、不能连续选择同一名玩家<br>2、技能生效后，你将失去此技能<br>3、不能自爆");
    });
    $("#AWK").click(() => {
        $("#hide>img").attr("src", "../../../image/id/AWK.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
        $("#poor2").html("晚上跟随其他狼队一起参与袭击讨论且拥有两个狼王爪，每晚袭击结束后可以向一名玩家传授狼王爪");
        $("#poor3").html("1、可以选择不传授，若这样做，你可以保留至下一夜晚<br>2、传授到狼王爪的狼人拥有【出局带人】的技能，使用条件等同于狼王<br>3、如果觉醒狼王在没有传授狼王爪的情况下出局，则可以带走两名玩家，带人条件等同于狼王")
    });
    $("#RW").click(() => {
        $("#hide>img").attr("src", "../../../image/id/RW.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
        $("#poor2").html("不和其他狼人见面，最后一狼接刀，从第二晚开始，你可以发动仅有一次的【轮回】技能");
        $("#poor3").html("1、被轮回的玩家的技能可以保留<br>2、轮回的效果详见【版型说明】<br>3、你不会被传授狼王爪")
    });
    $("#gargoyle").click(() => {
        $("#hide>img").attr("src", "../../../image/id/gargoyle.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
        $("#poor2").html("不和其他狼人见面，每天晚上查验玩家具体身份，最后一狼时接刀");
        $("#poor3").html("1、和通灵师一样，不能查验自己<br>2、和通灵师一样不能查验已经查验过的玩家或已经翻牌的玩家<br>3、和通灵师一样可以不查验，但是不建议这样操作")
    });
    $("#BV").click(() => {
        $("#hide>img").attr("src", "../../../image/id/BV.jpg");
        $("#poor1").html("属于狼人阵营，胜利条件和狼人相同");
        $("#poor2").html("不和其他狼人见面，每天晚上可以对一名玩家进行【票型污染】，被票型污染的玩家的放逐投票会视为【无效票】");
        $("#poor3").html("1、不能连续污染同一名玩家<br>2、如果被【票型污染】的玩家投票，则会在唱票时宣布哪名玩家身上有【无效票】<br>3、如果被【票型污染】的玩家弃票，则法师的技能将会被冷却一天<br>4、如果【禁锢】和【票型污染】在同一名玩家上，则该玩家出局")
    });
    // 平民、待定、三方阵营
    $("#villager").click(() => {
    ...
    $("#good").click(() => {
        $("#hide>img").attr("src", "../../../image/id/good.jpg");
        $("#poor1").html("属于好人平民，胜利条件和平民相同");
        $("#poor2").html("白天可以自爆，自爆后翻开身份牌");
        $("#poor3").html("暂无");
    });
    $("#lonely").click(() => {
        $("#hide>img").attr("src", "../../../image/id/lonely.jpg");
    ...
    $("#curse").click(() => {
        $("#hide>img").attr("src", "../../../image/id/curse.jpg");
    ...
    $("#sun").click(() => {
        $("#hide>img").attr("src", "../../../image/id/sun.jpg");
        $("#poor1").html("属于好人平民，胜利条件和平民相同");
        $("#poor2").html("出局时翻牌，然后跳过一个夜晚");
        $("#poor3").html("如果自己作为最后的平民出局，则无法发动技能");
    });
    $("#moon").click(() => {
        $("#hide>img").attr("src", "../../../image/id/moon.jpg");
        $("#poor1").html("属于好人平民，胜利条件和平民相同");
        $("#poor2").html("出局时翻牌，然后跳过一个白天");
        $("#poor3").html("如果自己作为最后的平民出局，则无法发动技能");
    });
    $("#love").click(() => {
        $("#hide>img").attr("src", "../../../image/id/love.jpg");
    ...
    $("#mixedblood").click(() => {
        $("#hide>img").attr("src", "../../../image/id/MB.jpg");
        $("#poor1").html("属于好人平民，胜利条件和平民相同");
    ...
    $("#VKG").click(() => {
        $("#hide>img").attr("src", "../../../image/id/VKG.jpg");
    ...
    $("#senior").click(() => {
        $("#hide>img").attr("src", "../../../image/id/senior.jpg");
        $("#poor1").html("属于好人平民，胜利条件和平民相同");
        $("#poor2").html("天亮后翻开自己的身份牌");
        $("#poor3").html("1、你的翻牌技能是强制性的，不能不翻<br>2、翻牌时间为警长竞选之后");
    });
    $("#postman").click(() => {
        $("#hide>img").attr("src", "../../../image/id/postman.jpg");
        $("#poor1").html("属于好人平民，胜利条件和平民相同");
        $("#poor2").html("第一天获知淘女郎选择了什么商品，出局时翻牌");
        $("#poor3").html("1、如果淘女郎选择了【查验】和【毒药】，则淘女郎在第三天夜晚获得技能<br>2、如果淘女郎选择了【猎枪】，则淘女郎在第三天白天获得技能<br>3、如果在淘女郎获得技能之前你出局了，则淘女郎无法获得任何技能");
    });
    // 神职阵营
    $("#seer").click(() => {
    ...
    $("#PW").click(() => {
        $("#hide>img").attr("src", "../../../image/id/PW.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#keeper").click(() => {
        $("#hide>img").attr("src", "../../../image/id/keeper.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#knight").click(() => {
        $("#hide>img").attr("src", "../../../image/id/knight.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#milktea").click(() => {
        $("#hide>img").attr("src", "../../../image/id/milktea.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#sb").click(() => {
        $("#hide>img").attr("src", "../../../image/id/sb.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#hypnotist").click(() => {
        $("#hide>img").attr("src", "../../../image/id/hypnotist.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#demon").click(() => {
        $("#hide>img").attr("src", "../../../image/id/demon.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#count").click(() => {
        $("#hide>img").attr("src", "../../../image/id/count.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#dream").click(() => {
        $("#hide>img").attr("src", "../../../image/id/dream.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#crow").click(() => {
        $("#hide>img").attr("src", "../../../image/id/crow.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#pab").click(() => {
        $("#hide>img").attr("src", "../../../image/id/PAB.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#BC").click(() => {
        $("#hide>img").attr("src", "../../../image/id/BC.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#dancer").click(() => {
        $("#hide>img").attr("src", "../../../image/id/dancer.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#BM").click(()=>{
        $("#hide>img").attr("src", "../../../image/id/BM.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
        $("#poor2").html("晚上选择一名玩家成为幸运儿，并从【查验】、【毒药】和【猎枪】中选择一个技能给予幸运儿");
        $("#poor3").html("1、不能选择自己为幸运儿<br>2、选择幸运儿后，无论幸运儿是否存活，不能选择新的幸运儿<br>3、幸运儿如果为好人，则幸运儿获得该技能<br>4、幸运儿如果为狼队，则幸运儿不会获得该技能且黑市商人出局（包括狼兄未出局时的狼弟）<br>5、黑市商人可以空过，将技能保留到下一晚再使用<br>6、获得商品的幸运儿可以空过，将获得的商品保留到下一晚再使用<br>7、游戏有单独的幸运儿发动技能的环节<br>8、幸运儿获得技能当晚只能获得幸运儿信息，次日夜晚才能发动技能（猎枪除外）");
    });
    $("#spy").click(()=>{
        $("#hide>img").attr("src", "../../../image/id/spy.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#SWAT").click(()=>{
        $("#hide>img").attr("src", "../../../image/id/SWAT.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
    ...
    $("#reincarnator").click(() => {
        $("#hide>img").attr("src", "../../../image/id/reincarnator.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
        $("#poor2").html("从第二晚开始，你可以发动仅有一次的【轮回】技能");
        $("#poor3").html("1、被轮回的玩家的技能可以保留<br>2、轮回的效果详见【版型说明】")
    });
    $("#vote").click(() => {
        $("#hide>img").attr("src", "../../../image/id/vote.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
        $("#poor2").html("拥有三个不同的技能<br>（1）禁锢：被禁锢的玩家无法投票<br>（2）祝福：被祝福的玩家在投票时，一票当两票，唱票时公示哪名玩家身上有【祝福票】<br>（3）诅咒：被诅咒的玩家在唱票时，身上会多一张被放逐票，且会被公示");
        $("#poor3").html("1、除了技能（1），其他技能全局游戏只能发动一次<br>2、【禁锢】技能不能对已经禁锢过的玩家使用<br>3、可以一次性发动全部技能<br>4、禁锢结果会在放逐发言结束，放逐投票之前公示<br>5、如果【禁锢】和【票型污染】在同一名玩家上，则该玩家出局")
    });
    $("#taobao").click(() => {
        $("#hide>img").attr("src", "../../../image/id/taobao.jpg");
        $("#poor1").html("属于好人神职，胜利条件和平民相同");
        $("#poor2").html("第一天夜晚从【查验】【毒药】和【猎枪】里选择一件商品，【查验】和【毒药】会在第三天夜晚获得并使用，【猎枪】会在第三天白天获得");
        $("#poor3").html("1、第一天夜晚你必须选择，不能不选择<br>2、你获得的技能只能发动一次<br>3、你获得的技能可以选择保留到下一晚使用<br>4、如果在你获得技能之前快递员出局，则你不能获得技能")
    });
})
